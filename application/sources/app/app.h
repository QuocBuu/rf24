...
/* define signal */
enum {
	AC_TASK_HELLO_PRINT = AK_USER_DEFINE_SIG,
};
...
/*****************************************************************************/
/* define timer */
#define TASK_HELLO_TIMER_1_INTERVAL									(2000)
#define TASK_HELLO_TIMER_2_INTERVAL									(3000)
/* define signal */
enum {
	AC_TASK_HELLO_X_PRINT = AK_USER_DEFINE_SIG,
	AC_TASK_HELLO_X_TIMER_1,
	AC_TASK_HELLO_X_TIMER_2,
};
