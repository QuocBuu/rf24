...
int led_b5;
int recv_data;
char textToSend[32] = "Hello, Phan Quoc Buu 1!";
char textToRecv[32];
...
/** Send data with nf24 pure send
 * @param add Address send
 * @param des_task_id Destination task ID
 * @param sig Signal 
 */
void nf24_pure_send(uint8_t add, task_id_t des_task_id, uint8_t sig) {
	// init message
...
/** Send data with nf24 common send
 * @param add Address send
 * @param des_task_id Destination task ID
 * @param sig Signal 
 * @param data Data receice
