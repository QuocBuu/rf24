 ...
 */
void app_task_init() {
	SCREEN_CTOR(&scr_mng_app, scr_nf24_handle, &scr_nf24);

	// task_post_pure_msg(AC_TASK_RF24_IF_ID, AC_RF24_IF_INIT_NETWORK);
	#if defined(IF_NF24_MASTER_EN)
	task_post_pure_msg(AC_TASK_NF24_MASTER_ID, AC_NF24_MASTER_INIT_NETWORK);
	#else
	task_post_pure_msg(AC_TASK_NF24_CLIENT_ID, AC_NF24_CLIENT_INIT_NETWORK);
	#endif
