...
/*****************************************************************************/
/*  NF24 MASTER task define
 */
/*****************************************************************************/
/* define timer */
#define SCR_NF24_MASTER_FEEDBACK_INTERVAL										(500)

/* define signal */
enum {
	AC_NF24_MASTER_INIT_NETWORK = AK_USER_DEFINE_SIG,
	AC_NF24_MASTER_PURE_SEND_ONE,
	AC_NF24_MASTER_PURE_SEND_ALL,
	AC_NF24_MASTER_COMMON_SEND_ONE,
	AC_NF24_MASTER_COMMON_SEND_ALL,
	AC_NF24_MASTER_REQUEST_FEEDBACK,
	AC_NF24_MASTER_PURE_RECV,
	AC_NF24_MASTER_COMMON_RECV,
	AC_NF24_MASTER_INTERRUPT_SEND,

	AC_NF24_MASTER_CONTROL_LED_SEND,
	AC_NF24_MASTER_BUTTON_STATUS_RECV,
	AC_NF24_MASTER_TIMER_FEEDBACK
};

/*****************************************************************************/
/*  NF24 CLIENT task define
 */
/*****************************************************************************/
/* define timer */
/* define signal */
enum {
	AC_NF24_CLIENT_INIT_NETWORK = AK_USER_DEFINE_SIG,
	AC_NF24_CLIENT_PURE_SEND,
	AC_NF24_CLIENT_COMMON_SEND,
	AC_NF24_CLIENT_PURE_RECV,
	AC_NF24_CLIENT_COMMON_RECV,
	AC_NF24_CLIENT_CONTROL_LED_RECV,
	AC_NF24_CLIENT_BUTTON_STATUS_SEND
};
