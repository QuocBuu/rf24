 ...
 *Pin map led B5
******************************************************************************/
#define LED_B5_IO_PIN					(GPIO_Pin_5)
#define LED_B5_IO_PORT					(GPIOB)
#define LED_B5_IO_CLOCK					(RCC_AHBPeriph_GPIOB)
...
*******************************************************************************/
extern void led_B5_init();
extern void led_B5_on();
extern void led_B5_off();
