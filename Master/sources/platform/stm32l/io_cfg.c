...
void led_B5_init() {
	...
	RCC_AHBPeriphClockCmd(LED_B5_IO_CLOCK, ENABLE);

	GPIO_InitStructure.GPIO_Pin = LED_B5_IO_PIN;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;
	GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz;
	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_DOWN;
	GPIO_Init(LED_B5_IO_PORT, &GPIO_InitStructure);
}

void led_B5_on() {
	GPIO_SetBits(LED_B5_IO_PORT, LED_B5_IO_PIN);
}

void led_B5_off() {
	GPIO_ResetBits(LED_B5_IO_PORT, LED_B5_IO_PIN);
}
